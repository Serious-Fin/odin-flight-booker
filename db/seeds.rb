...
flights = Flight.create([
  { departure_airport_id: 1, arrival_airport_id: 2, departure_time: DateTime.new(2023, 06, 10, 08, 22, 00), duration: "2:30:00"},
  ...
  { departure_airport_id: 1, arrival_airport_id: 5, departure_time: DateTime.new(2023, 06, 20, 09, 16, 00), duration: "1:50:00"},
  ...
  { departure_airport_id: 3, arrival_airport_id: 7, departure_time: DateTime.new(2023, 07, 02, 06, 40, 00), duration: "1:20:00"},
  ...
  { departure_airport_id: 6, arrival_airport_id: 1, departure_time: DateTime.new(2023, 06, 14, 08, 09, 00), duration: "3:05:00"}
])